...
export default function AppointmentBooking({ copy }: { copy: ContactCopy }) {
    ...
    function submit(event: FormEvent<HTMLFormElement>) {
        ...
        localStorage.setItem("nby-appointment", JSON.stringify({ type, date, time, firstName: form.get("firstName"), lastName: form.get("lastName"), email: form.get("email"), phone: form.get("phone"), note: form.get("note") }));
        setConfirmed(true);
    }
