            ...
            {features.map((feature, index) => {
                ...
                return (
                    <motion.article
                        ...
                        className="rounded border border-slate-200 bg-white p-7 shadow-sm shadow-slate-100 transition hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-200"
                    >
                        <div className="mb-7 flex h-11 w-11 items-center justify-center rounded bg-cyan-50 text-[#123a56]">
...
function DarkCta({
    ...
    return (
        <section className="bg-white px-5 py-24 sm:px-8 lg:px-24">
            <motion.div
                {...fadeUp}
                className="relative mx-auto max-w-[1260px] overflow-hidden rounded bg-[#102f47] px-8 py-16 text-center text-white shadow-2xl shadow-slate-300 lg:px-20"
            >
                ...
                <div className="relative z-10">
                    ...
                    <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row">
                        <Link className="inline-flex h-13 items-center justify-center rounded bg-[#123a56] px-8 text-sm font-black text-white shadow-lg shadow-cyan-950/30" href="/contact">
                            {primary}
                        </Link>
                        {secondary && (
                            <a className="inline-flex h-13 items-center justify-center rounded border border-white/15 bg-white/[0.06] px-8 text-sm font-black text-white" href="#methodology">
                                {secondary}
                            </a>
                        )}
                    </div>
...
export function GovernmentLandingPage() {
    ...
    return (
        <>
                ...
                <div className="relative z-10 mx-auto grid min-h-[650px] max-w-[1420px] items-center gap-14 px-5 py-24 sm:px-8 lg:grid-cols-[0.95fr_1.05fr] lg:px-24">
                    <motion.div initial={{ opacity: 0, y: 34 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.75 }}>
                        ...
                        <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                            <Link href="/contact" className="inline-flex h-12 items-center justify-center gap-2 rounded bg-[#123a56] px-7 text-sm font-black text-white">
                                {c.primary} <ArrowRight className="h-4 w-4" />
                            </Link>
                            <a href="#methodology" className="inline-flex h-12 items-center justify-center rounded bg-white/10 px-7 text-sm font-black text-white">
                                {c.secondary}
                            </a>
                        </div>
                    </motion.div>
                    <motion.div initial={{ opacity: 0, scale: 0.92 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.15 }} className="relative min-h-[420px]">
                        ...
                        <div className="absolute left-1/2 top-1/2 h-44 w-44 -translate-x-1/2 -translate-y-1/2 rounded border-[22px] border-[#123a56]/50" />
                        <div className="absolute right-10 top-16 rounded bg-white/80 px-5 py-4 text-sm font-black text-slate-700 shadow-xl">Anomaly Detected: 0.002%</div>
                        <div className="absolute bottom-20 left-12 rounded bg-white/80 px-5 py-4 text-sm font-black text-slate-700 shadow-xl">$420.5M Optimization</div>
                    </motion.div>
                </div>
            </section>
                ...
                <div className="relative z-10 mx-auto max-w-[1260px]">
                    ...
                    <div className="mt-14 grid gap-7 md:grid-cols-4">
                        {["Data Ingestion", "Resolve", "Model", "Enforce"].map((step, index) => (
                            <motion.article key={step} {...fadeUp} transition={{ duration: 0.55, delay: index * 0.08 }} className="rounded border border-white/10 bg-white p-7 text-[#102f47] first:bg-[#11183a] first:text-white">
            ...
            <section className="bg-white px-5 py-28 sm:px-8 lg:px-24">
                <motion.div {...fadeUp} className="mx-auto grid max-w-[1120px] overflow-hidden rounded bg-white shadow-2xl shadow-slate-300 lg:grid-cols-2">
                    <div className="p-12">
                    ...
                    <div className="bg-gradient-to-br from-[#123a56] to-cyan-400 p-12">
                        <Image src="/generated/financial-intelligence-workstation.png" alt="Command center" width={800} height={450} className="h-full min-h-[280px] w-full rounded object-cover" />
                    </div>
                </motion.div>
            </section>
        ...
        <>
                ...
                <div className="mx-auto grid max-w-[1260px] items-center gap-14 lg:grid-cols-2">
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
                        ...
                        <div className="mt-9 flex gap-4">
                            <Link href="/contact" className="inline-flex h-12 items-center rounded bg-[#123a56] px-7 text-sm font-black text-white">{c.primary}</Link>
                            <a href="#cases" className="inline-flex h-12 items-center rounded border border-slate-200 px-7 text-sm font-black text-[#102f47]">{c.secondary}</a>
                        </div>
                    </motion.div>
                    <motion.div
                    ...
                    >
                        ...
                        <div className="relative overflow-hidden rounded border border-slate-200 bg-white shadow-2xl shadow-slate-300">
                            <Image
                        ...
                        <div className="absolute -bottom-6 left-8 rounded border border-white/60 bg-white/90 px-6 py-4 shadow-2xl shadow-slate-300 backdrop-blur">
            ...
            <section className="relative overflow-hidden bg-[#102f47] px-5 py-28 text-white sm:px-8 lg:px-24">
                ...
                <div className="relative z-10 mx-auto grid max-w-[1260px] items-center gap-16 lg:grid-cols-2">
                    ...
                    <motion.div {...fadeUp} className="rounded bg-white/[0.06] p-8 shadow-2xl shadow-black/30">
                ...
                <div className="mx-auto grid max-w-[1120px] gap-12 lg:grid-cols-2">
                    <motion.div {...fadeUp}>
                        ...
                        <div className="mt-8 space-y-4">
                            <div className="rounded bg-cyan-50 p-5 text-xl font-black text-[#123a56]">85% <span className="text-sm text-slate-500">Accuracy improvement</span></div>
                            <div className="rounded bg-cyan-50 p-5 text-xl font-black text-cyan-500">$14M <span className="text-sm text-slate-500">Avg. revenue recovery</span></div>
                        </div>
                    </motion.div>
                    <motion.div {...fadeUp} className="space-y-5">
                        {["The granularity of iKwook's churn models allowed us to save $4.2M in enterprise contracts.", "Implementing resource loss detection transformed supply-chain transparency."].map((quote) => (
                            <blockquote key={quote} className="rounded border border-slate-200 bg-white p-7 text-base font-semibold leading-7 text-slate-600 shadow-sm">“{quote}”</blockquote>
                        ))}
                    </motion.div>
                </div>
            </section>
            ...
            <section className="bg-gradient-to-r from-white to-cyan-50 px-5 py-28 sm:px-8 lg:px-24">
                <div className="mx-auto grid max-w-[1260px] items-center gap-14 lg:grid-cols-2">
                    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
                        ...
                        <div className="mt-9 flex gap-4">
                            <Link href="/contact" className="inline-flex h-12 items-center rounded bg-[#123a56] px-7 text-sm font-black text-white">{c.primary}</Link>
                            <a href="#plans" className="inline-flex h-12 items-center rounded border border-slate-200 bg-white px-7 text-sm font-black text-[#102f47]">{c.secondary}</a>
                        </div>
                    </motion.div>
                    <motion.div
                        initial={{ opacity: 0, scale: 0.94, x: 28 }}
                    ...
                    >
                        ...
                        <div className="relative overflow-hidden rounded border border-white bg-white shadow-2xl shadow-slate-300">
                            <Image
                        ...
                        <div className="absolute -bottom-6 right-8 rounded border border-white/60 bg-white/90 px-6 py-4 shadow-2xl shadow-slate-300 backdrop-blur">
            ...
            <section className="bg-white px-5 py-28 text-center sm:px-8 lg:px-24">
                ...
                <div className="mx-auto mt-16 grid max-w-[1120px] gap-6 md:grid-cols-4">
                    {c.steps.map((step, index) => (
                        <motion.article key={step} {...fadeUp} transition={{ duration: 0.55, delay: index * 0.08 }} className="rounded border border-slate-200 bg-white p-7 text-left shadow-lg shadow-slate-100">
            ...
            <section id="plans" className="bg-cyan-50/50 px-5 py-28 sm:px-8 lg:px-24">
                <div className="mx-auto grid max-w-[1120px] items-center gap-10 lg:grid-cols-[0.85fr_1fr_1fr]">
                    ...
                    {["Premium|$499|For growing portfolios", "Private Wealth|$1,950|For complex estates"].map((plan, index) => {
                        ...
                        return (
                            <motion.article key={name} {...fadeUp} transition={{ duration: 0.6, delay: index * 0.08 }} className={`rounded p-9 shadow-2xl ${index ? "bg-[#102f47] text-white shadow-slate-300" : "bg-white text-[#102f47] shadow-slate-300"}`}>
                                ...
                                <button className="mt-8 h-11 w-full rounded bg-[#123a56] text-sm font-black text-white">Contact Access</button>
                            </motion.article>
                        );
                    })}
                </div>
        ...
        <>
            <section className="bg-slate-50 px-5 py-24 sm:px-8 lg:px-24">
                <div className="mx-auto grid max-w-[1260px] items-center gap-14 lg:grid-cols-[0.92fr_1.08fr]">
                    ...
                    >
                        ...
                        <div className="relative overflow-hidden rounded bg-[#102f47] shadow-2xl shadow-slate-300">
                            <Image
            ...
            <section className="bg-white px-5 py-24 sm:px-8 lg:px-24">
                <div className="mx-auto grid max-w-[1260px] gap-10 lg:grid-cols-[1.08fr_0.92fr]">
                    <motion.form {...fadeUp} className="rounded border border-slate-200 bg-white p-7 text-left shadow-2xl shadow-slate-200 sm:p-9">
                        ...
                        <div className="mt-8 grid gap-4 md:grid-cols-2">
                            {fieldValues.map((label) => (
                                <label key={label} className="text-xs font-black uppercase text-slate-500">
                                    {label}
                                    <input className="mt-2 h-11 w-full rounded border border-slate-200 bg-slate-50/60 px-4 text-sm outline-none transition focus:border-[#123a56] focus:bg-white" />
                                </label>
                            ))}
                        </div>
                        <label className="mt-4 block text-xs font-black uppercase text-slate-500">
                            {c.fields.subject}
                            <textarea className="mt-2 h-20 w-full rounded border border-slate-200 bg-slate-50/60 p-4 text-sm outline-none transition focus:border-[#123a56] focus:bg-white" />
                        </label>
                        <label className="mt-4 block text-xs font-black uppercase text-slate-500">
                            {c.fields.message}
                            <textarea className="mt-2 h-32 w-full rounded border border-slate-200 bg-slate-50/60 p-4 text-sm outline-none transition focus:border-[#123a56] focus:bg-white" />
                        </label>
                        <div className="mt-5 flex items-center gap-4 rounded border border-dashed border-slate-200 bg-slate-50/60 p-4">
                        ...
                        <button type="button" className="mt-7 flex h-13 w-full items-center justify-center gap-3 rounded bg-[#123a56] text-base font-black text-white shadow-lg shadow-cyan-200 transition hover:bg-[#0f2f47]">
                            {c.submit} <Send className="h-5 w-5" />
                        </button>
                    </motion.form>

                    <div className="space-y-6">
                        <motion.div {...fadeUp} className="relative overflow-hidden rounded bg-[#102f47] p-8 text-white shadow-2xl shadow-slate-300">
                        ...
                        <motion.div {...fadeUp} className="rounded border border-slate-200 bg-slate-50 p-7">
...
function ContactLine({
    ...
    return (
        <div className={`flex items-center gap-4 rounded p-4 ${dark ? "bg-white/8" : "bg-white"}`}>
            <span className={`flex h-11 w-11 shrink-0 items-center justify-center rounded ${dark ? "bg-white/10 text-cyan-300" : "bg-cyan-50 text-[#123a56]"}`}>
                <Icon className="h-5 w-5" />
            </span>
