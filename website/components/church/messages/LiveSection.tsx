...
export default function LiveSection({ copy, liveVideoId }: { copy: MessagesCopy; liveVideoId?: string }) {
    const videoId = liveVideoId ?? CURRENT_LIVE_VIDEO_ID ?? LATEST_BROADCAST_VIDEO_ID;
    const isLive = Boolean(liveVideoId ?? CURRENT_LIVE_VIDEO_ID);
