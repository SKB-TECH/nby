...
export default function GivingHero({ copy }: { copy: GivingCopy }) {
    return (
        <section className="relative min-h-[540px] overflow-hidden bg-[#071117] text-white">
            <Image src="/church/giving-hero-nby.jpeg" alt={copy.title} fill preload sizes="100vw" className="object-cover object-center opacity-75" />
            <div className="absolute inset-0 bg-gradient-to-r from-[#071117]/95 via-[#071117]/60 to-[#071117]/10" />
            ...
            <div className="relative z-10 mx-auto flex min-h-[540px] max-w-[1180px] items-center px-5 py-24 sm:px-8">
                <motion.div initial="hidden" animate="visible" variants={{ hidden: {}, visible: { transition: { staggerChildren: .12 } } }} className="max-w-3xl">
                    <motion.p variants={{ hidden: { opacity: 0, y: 12 }, visible: { opacity: 1, y: 0 } }} className="border-l-2 border-[#f0a40b] pl-4 text-[11px] font-black uppercase tracking-[.3em] text-[#f0a40b]">{copy.eyebrow}</motion.p>
